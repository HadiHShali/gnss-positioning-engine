...
This portfolio is designed to demonstrate readiness for positions such as:

- **Navigation Engineer — State Estimation** (spacecraft applications)
- **GNSS Algorithm Engineer** (Trimble, u-blox, Septentrio, NovAtel)
- **Estimation Engineer** for LEO / VLEO platforms (Logos Space, Albedo, Spire Global)
- **GNSS Software Engineer** (Hexagon, Planet Labs)
